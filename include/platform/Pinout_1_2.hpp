...
static constexpr gpio_num_t Down = GPIO_NUM_36;
static constexpr gpio_num_t Left = GPIO_NUM_32;
static constexpr gpio_num_t Right = GPIO_NUM_13;
static constexpr gpio_num_t Enter = GPIO_NUM_35;
} // namespace Arrows
...
static constexpr bool GeneratorBuzzer = true;

static constexpr gpio_num_t LedPower = GPIO_NUM_26;
static constexpr bool InvertLedPower = false;
